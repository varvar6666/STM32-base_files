...
uint32_t vector_table[] = {
	...
	(uint32_t) DFSDM1_FLT4_IRQHandler,
	(uint32_t) DFSDM1_FLT5_IRQHandler,
	(uint32_t) DFSDM1_FLT6_IRQHandler,
	(uint32_t) DFSDM1_FLT7_IRQHandler,
	...
	(uint32_t) 0,
	(uint32_t) DAC2_IRQHandler,
	(uint32_t) DMAMUX2_OVR_IRQHandler,
	(uint32_t) BDMA2_Channel0_IRQHandler,
	(uint32_t) BDMA2_Channel1_IRQHandler,
	(uint32_t) BDMA2_Channel2_IRQHandler,
	(uint32_t) BDMA2_Channel3_IRQHandler,
	(uint32_t) BDMA2_Channel4_IRQHandler,
	(uint32_t) BDMA2_Channel5_IRQHandler,
	(uint32_t) BDMA2_Channel6_IRQHandler,
	(uint32_t) BDMA2_Channel7_IRQHandler,
	...
	(uint32_t) OTFDEC1_IRQHandler,
	(uint32_t) OTFDEC2_IRQHandler,
	(uint32_t) GFXMMU_IRQHandler,
	(uint32_t) BDMA1_IRQHandler,
};
