...
uint32_t vector_table[] = {
	...
	(uint32_t) DFSDM2_FLT0_IRQHandler,
	(uint32_t) DFSDM2_FLT1_IRQHandler,
	(uint32_t) DFSDM2_FLT2_IRQHandler,
	(uint32_t) DFSDM2_FLT3_IRQHandler,
};
